...
import (
	...
	bs "github.com/cc14514/go-ipfs/blocks/blockstore"
	bstore "github.com/cc14514/go-ipfs/blocks/blockstore"
	bserv "github.com/cc14514/go-ipfs/blockservice"
	"github.com/cc14514/go-ipfs/commands/files"
	core "github.com/cc14514/go-ipfs/core"
	"github.com/cc14514/go-ipfs/exchange/offline"
	balanced "github.com/cc14514/go-ipfs/importer/balanced"
	"github.com/cc14514/go-ipfs/importer/chunk"
	ihelper "github.com/cc14514/go-ipfs/importer/helpers"
	trickle "github.com/cc14514/go-ipfs/importer/trickle"
	dag "github.com/cc14514/go-ipfs/merkledag"
	mfs "github.com/cc14514/go-ipfs/mfs"
	"github.com/cc14514/go-ipfs/pin"
	posinfo "github.com/cc14514/go-ipfs/thirdparty/posinfo"
	unixfs "github.com/cc14514/go-ipfs/unixfs"
...
func (adder Adder) add(reader io.Reader) (node.Node, error) {
	...
	dlog.Println("coreunix/add.go : add : params.RawLeaves =",params.RawLeaves)
	dlog.Println("coreunix/add.go : add : adder.Trickle =",adder.Trickle)
	if adder.Trickle {
