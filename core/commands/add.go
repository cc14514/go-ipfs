...
import (
	...
	blockservice "github.com/cc14514/go-ipfs/blockservice"
	cmds "github.com/cc14514/go-ipfs/commands"
	files "github.com/cc14514/go-ipfs/commands/files"
	core "github.com/cc14514/go-ipfs/core"
	"github.com/cc14514/go-ipfs/core/coreunix"
	offline "github.com/cc14514/go-ipfs/exchange/offline"
	dag "github.com/cc14514/go-ipfs/merkledag"
	dagtest "github.com/cc14514/go-ipfs/merkledag/test"
...
`,
	...
	Options: []cmds.Option{
		...
		cmds.BoolOption(trickleOptionName, "t", "Use trickle-dag format for dag generation.").Default(true),
		cmds.BoolOption(onlyHashOptionName, "n", "Only chunk and hash - do not write to disk."),
		cmds.BoolOption(wrapOptionName, "w", "Wrap files with a directory object."),
		cmds.BoolOption(hiddenOptionName, "H", "Include files that are hidden. Only takes effect on recursive add."),
		cmds.StringOption(chunkerOptionName, "s", "Chunking algorithm to use."),
		cmds.BoolOption(pinOptionName, "Pin this object when adding.").Default(false),
		cmds.BoolOption(rawLeavesOptionName, "Use raw blocks for leaf nodes. (experimental)").Default(true),
