...
[![GoDoc](https://godoc.org/github.com/cc14514/go-ipfs?status.svg)](https://godoc.org/github.com/cc14514/go-ipfs)
...
Please put all issues regarding the Go IPFS _implementation_ in [this repo](https://github.com/cc14514/go-ipfs/issues).
...
```
$ go get -u -d github.com/cc14514/go-ipfs
...
* *WARNING: Older versions of OSX FUSE (for Mac OS X) can cause kernel panics when mounting!*
  ...
  (See https://github.com/cc14514/go-ipfs/issues/177)
...
For any other problems, check the [issues list](https://github.com/cc14514/go-ipfs/issues)
and if you dont see your problem there, either come talk to us on irc (freenode #ipfs) or
file an issue of your own!

## Todo

An IPFS alpha version has been released in February 2015. Things left to be done are all marked as [issues](https://github.com/cc14514/go-ipfs/issues).
...
Main file: [cmd/ipfs/main.go](https://github.com/cc14514/go-ipfs/blob/master/cmd/ipfs/main.go) <br>
CLI Commands: [core/commands/](https://github.com/cc14514/go-ipfs/tree/master/core/commands) <br>
Bitswap (the data trading engine): [exchange/bitswap/](https://github.com/cc14514/go-ipfs/tree/master/exchange/bitswap)
