...
import (
	...
	engine "github.com/cc14514/go-ipfs/exchange/bitswap/decision"
	bsmsg "github.com/cc14514/go-ipfs/exchange/bitswap/message"
	bsnet "github.com/cc14514/go-ipfs/exchange/bitswap/network"
	wantlist "github.com/cc14514/go-ipfs/exchange/bitswap/wantlist"
		...
		case ws := <-pm.incoming:
			...
			if len(ws.targets) == 0 {
				for _, p := range pm.peers {
					debuglogger.Println("wantmanager.go ; peer.id =>",p.p)
